...
menu_def = [
    ['PyToolbox', ['Exit']],
    ['Tools', ['Calculator', 'Dart Score', 'Dice Roller', 'Timer', 'RNG', 'Converter', 'Stopwatch']],
...
window = sg.Window('PyToolBox', layout, size=(1280, 720))
...
while True:
    ...
    if event == 'Stopwatch':
        subprocess.Popen(['python3', './stopwatch.py'])
        break
